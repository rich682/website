...
const trustBadges = [
  { text: "Live walkthrough with a Vergo expert" },
  { text: "Tailored to your team's workflow" },
  { text: "Get up and running faster" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:sticky lg:top-36 lg:py-8">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-[#111] leading-[1.1] mb-6 tracking-tight">
              Get your team{" "}
              <span className="block text-[#6366F1]">up to speed.</span>
            </h1>
            <p className="text-lg text-[#666] max-w-lg mb-10 leading-relaxed">
              Schedule a training session with a Vergo expert. We&apos;ll walk
              your team through the platform, answer questions, and make sure
