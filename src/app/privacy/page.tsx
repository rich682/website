...
export const metadata: Metadata = {
  ...
  description:
    "Vergo privacy policy — how we collect, use, and protect your personal information.",
};
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28">
        <article className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-10 text-[#555] leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">1. Updates to This Privacy Notice</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">2. Personal Information We Collect</h2>
              <h3 className="text-lg font-medium text-[#111] mb-2">Information you provide directly</h3>
              <p>
              ...
              <h3 className="text-lg font-medium text-[#111] mb-2 mt-4">Information collected automatically</h3>
              <p>
              ...
              <h3 className="text-lg font-medium text-[#111] mb-2 mt-4">Information from third parties</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">3. How We Use Personal Information</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">4. How We Share Personal Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">5. Your Privacy Choices</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">6. International Transfers</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">7. Children&apos;s Personal Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[#111] mb-3">8. Contact Us</h2>
              <p>
                If you have questions about this Privacy Notice or our privacy practices, please contact us at{" "}
                <a href="mailto:privacy@vergo.com" className="text-[#6366F1] hover:text-[#4F46E5] transition-colors">
                  privacy@vergo.com
                </a>.
              </p>
            </section>
