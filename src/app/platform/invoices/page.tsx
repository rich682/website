...
const features = [
  ...
  },
  {
    ...
    title: "GL Coding",
    description: "AI suggests general ledger codes, departments, and cost centers based on vendor history and invoice content. Override or confirm with a click.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Vergo automatically checks for duplicate invoices by vendor, amount, and invoice number. Prevent double payments before they happen.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
