...
const features = [
  ...
  },
  {
    ...
    description: "Generate detailed expense reports by period, client, department, or category. Export to Excel or sync with your accounting software.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Track reimbursement status from submission to payment. Team members see real-time updates on where their expense stands.",
  },
];
