...
const features = [
  ...
  },
  {
    ...
    description: "Built-in formula support lets you calculate totals, variances, percentages, and custom metrics directly within your reports.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Generate secure links to share reports with clients or stakeholders. No login required -- they see a polished, read-only view.",
  },
];
