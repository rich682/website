...
const features = [
  ...
  },
  {
    ...
    description: "Clients respond via email or a simple web link. They never need to create an account, download an app, or learn a new tool.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Requests go out from your firm's email address. Clients see communication from a familiar sender, not a third-party tool.",
  },
];
