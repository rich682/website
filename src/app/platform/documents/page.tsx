...
const features = [
  ...
  },
  {
    ...
    description: "All documents are encrypted at rest and in transit. Role-based access ensures only authorized team members can view sensitive files.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Bulk Download & Export",
    description: "Download all documents for a client or period as a structured ZIP. Export to your document management system or cloud drive.",
  },
];
