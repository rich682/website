...
const features = [
  ...
  },
  {
    ...
    description: "Assign tasks to team members, leave internal notes, and see who is working on what. Everyone stays aligned without status meetings.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    title: "Deadlines & Recurring Tasks",
    description: "Set due dates for each task and create templates for recurring work. Monthly closes, quarterly filings, and year-end procedures repeat automatically.",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
