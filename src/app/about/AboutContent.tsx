...
const values = [
  ...
  },
  {
    ...
    description: "Every action is logged. Structured sign-off workflows and locked periods create a complete audit trail -- so you are always ready for review, internal or external.",
