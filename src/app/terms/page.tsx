...
export const metadata: Metadata = {
  ...
  description: "Vergo terms of service — the agreement governing use of our platform and services.",
};
    ...
    <main className="pt-32 pb-20 lg:pt-40 lg:pb-28">
      <article className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose-vergo space-y-10 text-foreground-secondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">1. Vergo Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">2. Support</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">3. Pilot &amp; Trial</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">5. Ownership and Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">6. Representations and Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">7. Term</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">9. Effect of Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">11. Disclaimers; Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">13. Trademarks</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">14. Privacy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@vergo.com" className="text-accent hover:text-accent-hover transition-colors">
                legal@vergo.com
              </a>.
            </p>
          </section>
