...
export const metadata: Metadata = {
  title: "Request Tracking | Vergo",
  description:
    "Send requests to employees, vendors, clients, and contractors. Track responses and attachments in one centralized place.",
};

const features = [
  {
    category: "Send Requests",
    title: "Centralize and track requests across all your teams stakeholders",
    description:
      "Send requests to employees, vendors, clients, contractors, and any other stakeholder. Get the documents and approvals you need without chasing people across email, Teams, or spreadsheets.",
    items: [
      "Request documents and approvals",
      "Customize request templates",
      "Send to multiple stakeholders at once",
    ],
    mockup: "tracking",
  },
  {
    category: "Track Responses",
    title: "Monitor who has responded and who hasn't",
    description:
      "See real-time status on every request. Know exactly who has responded, who's still pending, and when responses are due. Get automatic reminders to follow up on overdue requests.",
    items: [
      "Real-time response tracking",
      "Automatic follow-up reminders",
      "Response timeline visibility",
    ],
    mockup: "workflow",
  },
  {
    category: "Manage Attachments",
    title: "Keep all files and responses in one place",
    description:
      "Collect all documents and attachments from stakeholders in a secure, centralized location. No more hunting through email inboxes or organizing files across different folders.",
    items: [
      "Centralized file storage",
      "Easy file organization by request",
      ...
      <section className="pt-32 pb-12 lg:pt-44 lg:pb-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-[#555] max-w-2xl mx-auto leading-relaxed">
            Send requests to employees, vendors, clients, and contractors. Track
            responses and attachments in one centralized place. Never wonder
            who's holding up your close.
          </p>
