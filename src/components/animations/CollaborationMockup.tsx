  ...
  const comments = [
    {
      ...
      name: "Sarah M.",
      color: "#6366F1",
      text: "Accounts tied out to GL — ready for review",
      time: "2m ago",
      cls: "1",
    },
    {
      ...
      name: "James R.",
      color: "#F59E0B",
      text: "Confirmed, balances match vendor invoices. Approved ✓",
      time: "1m ago",
      cls: "2",
    },
    {
      ...
      name: "Kate L.",
      color: "#22C55E",
      text: "Balance updated for Account 1042 — closing this task",
      time: "Just now",
      cls: "3",
    },
  ];
